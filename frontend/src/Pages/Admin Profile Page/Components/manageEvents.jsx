      ...
      <div className="form-section">
        <table className="form-table">
          <tbody>
            <tr>
              <td>Title</td>
              <td><input type="text" value={newEvent.title} onChange={(e) => setNewEvent({ ...newEvent, title: e.target.value })} /></td>
            </tr>
            <tr>
              <td>Date</td>
              <td><input type="date" value={newEvent.date} onChange={(e) => setNewEvent({ ...newEvent, date: e.target.value })} /></td>
            </tr>
            <tr>
              <td>Location</td>
              <td><input type="text" value={newEvent.location} onChange={(e) => setNewEvent({ ...newEvent, location: e.target.value })} /></td>
            </tr>
            <tr>
              <td>Description</td>
              <td><textarea value={newEvent.description} onChange={(e) => setNewEvent({ ...newEvent, description: e.target.value })} /></td>
            </tr>
          </tbody>
        </table>
